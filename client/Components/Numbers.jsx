      ...
      <div className="uk-container">
        <div className="uk-panel">
          ...
          >
            <div>
              <div className="uk-panel">
                <i className="uk-icon uk-icon-xlarge@m unicon-sub-volume uk-text-gradient" />
                <h4 className="uk-h3 uk-heading-d3@m uk-margin-xsmall uk-margin@m">
                  400+
                </h4>
            ...
            <div>
              <div className="uk-panel">
                <i className="uk-icon uk-icon-xlarge@m unicon-user-avatar uk-text-gradient" />
                <h4 className="uk-h3 uk-heading-d3@m uk-margin-xsmall uk-margin@m">
                  200+
                </h4>
                <span>Artists</span>
            ...
            <div>
              <div className="uk-panel">
                <i className="uk-icon uk-icon-xlarge@m unicon-theater uk-text-gradient" />
                <h4 className="uk-h3 uk-heading-d3@m uk-margin-xsmall uk-margin@m">
                  1860+
                </h4>
            ...
            <div>
              <div className="uk-panel">
                <i className="uk-icon uk-icon-xlarge@m unicon-rocket uk-text-gradient" />
                <h4 className="uk-h3 uk-heading-d3@m uk-margin-xsmall uk-margin@m">
                  2.5x
                </h4>
